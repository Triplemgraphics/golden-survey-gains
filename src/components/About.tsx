...
const About = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-background via-primary/5 to-background">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-card border border-border rounded-lg p-6">
                ...
                <h4 className="text-xl font-semibold mb-3">Targeted Research</h4>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold mb-3">Market Surveys</h4>
                <p className="text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold mb-3">Investment Intelligence</h4>
                <p className="text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h4 className="text-xl font-semibold mb-3">Local Partnerships</h4>
                <p className="text-muted-foreground">
          ...
          <div className="text-center bg-gradient-to-r from-primary/10 via-primary/5 to-primary/10 rounded-2xl p-12">
            ...
            <Button size="lg" className="font-semibold" onClick={scrollToContact}>
              Get Started Today
            </Button>
          </div>
        </div>
